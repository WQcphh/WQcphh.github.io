...
- 固定首页：展示最新一期简报
- 每日简报：AI、智能眼镜、ISP、图像传感器、光学
- 每周精读：低空经济、养老经济、具身智能、历史，仅保留最近 2 周
- 持续学习：每次显示 1 个任务，支持图文、视频链接或编程题
- 生活攻略：美食记录、旅游攻略、影视推荐
- 本地收藏/完成：状态只保存在当前浏览器
...
├─ data/site-structure.json      # 站点模块和存储规则
...
页面里的“收藏”和“完成”按钮使用浏览器 `localStorage`。状态只保存在当前设备的当前浏览器，不会上传到 GitHub，也不会同步到其他手机。
